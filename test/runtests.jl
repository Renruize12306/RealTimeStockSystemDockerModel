...
# !!! Main.UserApp is configured as an alias for Main.RealTimeStockSystemDockerModel and you might encounter it in some tests
using Main.RealTimeStockSystemDockerModel, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "RealTimeStockSystemDockerModel tests" begin
  @includetests ARGS
end
